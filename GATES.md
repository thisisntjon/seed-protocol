...
| G-002 | Publication: flip `thisisntjon/thefleet` to public as the Bonkers / SEED front door for simoneresearch.com. Preconditions met on branch `public-prep`: featured tree clean, board ticket paths stripped, checker green. Answering means: merge `public-prep`, set visibility public, then update the site card. | human | 2026-09-02 | ANSWERED |
