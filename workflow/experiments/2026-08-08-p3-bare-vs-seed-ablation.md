...
OBJECT:          Treatment protocol begins from SEED `d609ef97845a0cdfbf414cef007124d2fb2d16be`; task corpus, model identity, and arm artifacts must be hashed before execution.
