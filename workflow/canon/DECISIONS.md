...
| 2026-08-08 | Rules as prose or checks? | Every law that can be checked, is; PROSE laws are tracked debt | "Every encoded rule never failed again; every prose rule was violated at least once" | Never — this is the load-bearing bet of the skeleton |
| 2026-08-08 | Skeleton size | ~14 files; additions require a named incident | 646-tool sprawl was the origin corpus's anti-pattern | Never as a principle; individual additions via incident |
