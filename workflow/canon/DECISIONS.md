...
|---|---|---|---|---|
| 2026-09-01 | What is the public-display object after the investigation? | Wave A of `workflow/research/2026-09-01-public-display/SPEC.md` is applied: `JUDGES.md`, limitations-first README, weekly figure from `artifacts/summary.json`, hygiene rewrites (no Law-9 dollar, no replacement-cost dollars, no author desktop defaults, no claude.ai artifact URLs). C-004 stays HYPOTHESIS. Visibility flip remains a GATES publication. H2 dest-poison is not in this change. | T-001–T-006 briefs; identity tax and screenshot landmines were the bounce | A later board implements H2; or a human answers publication |
